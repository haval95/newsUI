...
function newsCardSkellaton() {
  return (
    <div
      role="status"
      className="  bg-white overflow-hidden  flex-1 min-w-[350px]  w-1/3 text-start p-3 border-gray-200 border "
    >
...
export default newsCardSkellaton;
